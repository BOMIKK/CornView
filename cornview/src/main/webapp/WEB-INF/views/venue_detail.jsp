	...
	<div class="body">
		<div class="left">
			...
			<img id="seat_img" name="mainvisualimg"
				src="./resources/img/gocheock_seat_preview__/gocheock_default_고척_Default.svg"
			...
			<map name="gcmap">
				...
				<area target="" href="/cornview/gc1"
					...
					onmouseout="if(document.images) mainvisualimg.src='./resources/img/gocheock_seat_preview__/gocheock_default_고척_Default.svg'"
					onfocus="this.blur()"
		...
		<div class="right">
			<div class="topInfo">
				<div class="areaInfo">101~114구역</div>
				<div class="areaInfo">
					<div class="dropdown">
