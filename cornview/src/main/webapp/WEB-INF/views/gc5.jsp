	...
	<div class="body">
		<div class="left">
			...
			<img id="seat_img" name="mainvisualimg"
				src="./resources/img/gocheock_seat_preview__/gocheock_default_고척_D01~D07.svg"
			...
			<map name="gcmap">
				...
				<area target="" href="/cornview/gc1"
					...
					onmouseout="if(document.images) mainvisualimg.src='./resources/img/gocheock_seat_preview__/gocheock_default_고척_D01~D07.svg'"
					onfocus="this.blur()"
		...
		<div class="right">
			<div class="topInfo">
				<div class="areaInfo">D01~D07구역</div>
				<div class="areaInfo">
					<div class="dropdown">
