	...
	<div class="body">
		<div class="left">
			...
			<img id="seat_img" name="mainvisualimg"
				src="./resources/img/gocheock_seat_preview__/gocheock_default_고척_101~114.svg"
			...
			<map name="gcmap">
				...
				<area target="" href="/cornview/gc1"
					...
					onmouseout="if(document.images) mainvisualimg.src='./resources/img/gocheock_seat_preview__/gocheock_default_고척_101~114.svg'"
					onfocus="this.blur()"
